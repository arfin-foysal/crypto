...
export default function AddNetwork() {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      toast.error(error?.data?.errors || 'Failed to add network');
    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center text-sm text-gray-500 mb-2">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-700">Add Network</span>
        </div>
        <h1 className="text-2xl font-bold text-gray-900">Add New Network</h1>
        <p className="text-gray-600 mt-1">Create a new blockchain network in the system</p>
      </div>
